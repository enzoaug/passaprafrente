...
<html lang="pt-br">
  ...
  <body>
    <header class="container-fluid header navbar-fixed-top">
      <div class="container">
        <div class="row">
          ...
          <button type="button" class="btn btn-primary bt-passa-pra-frente" data-toggle="modal" data-target="#compartilhandoThis">Passa pra frente!</button>
          <div class="btn-group grupo-bt">
            <button class="btn btn-default mensagem-bt" type="button" data-toggle="modal" data-target="#novidades"><i class="fa fa-envelope" aria-hidden="true"></i><span class="badge">12</span></button>  
            <button type="button" class="btn btn-default dropdown-toggle menu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="fa fa-bars" aria-hidden="true"></i>
            </button>
            <ul class="dropdown-menu menu-user"><!-- Dropdown do menu do usuáio -->
              <li class="coluna1">
                <div class="img-me"><img src="src/Assets/images/user.jpg" alt="Imagem do Usuário" class="img-circle"></div>
              ...
              <li class="coluna2">
                <button type="button" class="btn btn-default minhasMsg" data-toggle="modal" data-target="#minhasMsgModal">Minhas conversas</button>
                <button type="button" class="btn btn-default me-compartilhamentos" data-toggle="modal" data-target="#me-compartilhamentosModal">Compartilhamentos</button>
                <button type="button" class="btn btn-default alt-perfil" data-toggle="modal" data-target="#alt-perfilModal">Alterar perfil</button>
        ...
        <ul class="lista">
          <li class="listagem">
            ...
            <a href="javascript:void(0)" class="info-prod" data-toggle="modal" data-target="#Produto0001">
              ...
              <h3 class="lil-desc">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium</h3>
            </a>
          ...
          <ul class="paginacao">
            <li class="paginacao-item primeiro"><a href="#" class="paginacao-link btn-link"><i class="fa fa-angle-double-left" aria-hidden="true"></i></a></li>
            <li class="paginacao-item voltar"><a href="#" class="paginacao-link btn-link"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li>
            ...
            <li class="paginacao-item proximo"><a href="#" class="paginacao-link btn btn-link"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
            <li class="paginacao-item ultimo"><a href="#" class="paginacao-link btn btn-link"><i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
          </ul>
        </ul>
          ...
          <div class="modal-body">
            <div class="container produto-container">
              ...
              <div class="conteudo-R">
                ...
                <a href="#" class="btn btn-success eu-quero btn-lg" data-toggle="modal" data-target="#eu-queroModal">Eu quero!</a>
              ...
              <div class="opiniao-users">
                  ...
                  <div class="opiniao-users-texts">
                    <div class="opUsers-cont opUsers-cont-001">
                      <a href="#" class="user-pic"><img src="src/Assets/images/owner02.jpg" class="owner-img img-circle"></a>
                  ...
                  <div class="minha-opiniao">
                    <form>
                      <div class="form-group">
                        <label for="minha-opiniao-text">Escreva no campo abaixo sua opoinião sobre o item.</label>
                        <textarea class="form-control mOpiniao-tArea" rows="3" id="minha-opiniao-text"></textarea>
    ...
    <div class="modal fade" id="compartilhandoThis" tabindex="-1" role="dialog" aria-labelledby="primeiraVisitaLabel" data-backdrop="static">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body">
            <div id="contTelas2">
              ...
              <div class="telaPv telaPv5">
                ...
                <div class="telaPvCont form-group">
                  ...
                  <textarea class="form-control" id="descricao-do-item" placeholder="Descrição do Item" rows="3"></textarea>
                </div>
                <div class="telaPvButtons">
                  <a href="javascript:void(0);" class="link-voltar2 btn btn-secondary">Voltar</a>
                  <a href="javascript:void(0);" class="link-continuar2 btn btn-primary">Continuar</a>
              ...
              <div class="telaPv telaPv6">
                <h2>Obrigado!</h2>
                <p>Agora é só aguardar uma mensagem de interesse e conversar com as pessoas que querem este item que você não usa mais.</p>
                <div class="telaPvButtons">
                  <a href="javascript:void(0);" class="link-voltar2 btn btn-secondary">Voltar</a>
            ...
            <div class="cont-itens-compertilhados">
              ...
              <div class="item-compartilhado">
                ...
                <div class="cont-infos-item pull-right">
                  ...
                  <span class="compartilhado-por pull-left"><small>Compartilhado por: </small><span class="nome-do-compartilhador text-primary">Mim</span></span>
                  ...
                  <div class="cont-contrlStatus">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                      ...
                      <li><button type="button" class="btn btn-default btn-sm">Em andamento</button></li>
                      <li><button type="button" class="btn btn-success btn-sm">Finalizado</button></li>
                      <li><button type="button" class="btn btn-danger btn-sm">Cancelado</button></li>
                    </ul>  
                  </div>
                </div>
              </div>
              ...
              <div class="item-compartilhado">
                ...
                <div class="cont-infos-item pull-right">
                  <h4 class="nome-do-item pull-left">Lorem ipsum dolor</h4>
                  <span class="compartilhado-por pull-left"><small>Compartilhado por: </small><a href="#" class="nome-do-compartilhador text-info">Nome do usuário</a></span>
                  <small class="estado-troca bg-info">Em andamento</small>
                </div>
              </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group altPerfForm">
              ...
              <input type="text" class="form-control" id="esccreva-textoMsg" placeholder="Escreva aqui seu novo apelido">
            
              <label for="esccreva-textoMsg">Descrição</label>
              <input type="text" class="form-control" id="esccreva-textoMsg" placeholder="Escreva aqui sua descrição">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <h3 class="center-block text-info">Sua solicitação do item foi enviada com sucesso. Agora é só aguardar a resposta do compartilhador.</h3>
            <p class="center-block text-info">Você também pode escrever uma mensagem para o compartilhador deste item dizendo o quanto você gostou dele!</p>
          </div>
          <div class="modal-footer">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mensagens-anteriores">
              <a class="btn btn-link center-block" href="#" role="button"><small><i class="fa fa-long-arrow-up" aria-hidden="true"></i> Mensagens anteriores</small></a>
            </div>
